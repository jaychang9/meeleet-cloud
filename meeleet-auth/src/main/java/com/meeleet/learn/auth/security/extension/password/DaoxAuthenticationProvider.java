package com.meeleet.cloud.auth.security.extension.password;
...
/**
 * 扩展DaoAuthenticationProvider，支持多用户体系同认证方式的业务场景
 *
...
public class DaoxAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication)
        ...
        try {
            ...
            Map<String, String> params = (Map<String, String>) details;
            String clientId = params.get(SecurityConstants.CLIENT_ID_KEY);
            UserDetailsService userDetailsService = this.getUserDetailsService(clientId);
