...
public enum ResultCode implements CommonExceptionAssert, IResultCode, Serializable {
    ...
    UNSUPPORTED_GRANT_TYPE("A0213", "不支持的认证模式"),
    UNAUTHORIZED_GRANT_TYPE("A0214", "未授权的认证模式"),
    CLIENT_ID_OR_PASSWORD_ERROR("A0215", "客户端ID或客户端密码错误"),
    INVALID_SCOPE("A0216", "无效的Scope"),
    ...
    RESPONSE_RESULT_NOT_WRITABLE("A0407", "响应结果序列化失败"),
